...
export const LEARNING_STAGES: LearningStage[] = [
  ...
  },
  {
    ...
    biography: 'Zainab Shaikh, currently pursuing a Bachelor of Engineering (B.E.) degree, serves as the CTO of Zy Innovators, leading the organization\'s technical initiatives and program development. Her expertise spans robotics, electronics, programming, and educational content design. She is dedicated to designing hands-on curricula and interactive tools that inspire students to explore STEM fields and build real-world projects.',
    ...
    contributions: ['Designed robotics and electronics workshop curriculum', 'Created comprehensive educational resources', 'Developed the Zy Innovators assessment framework'],
